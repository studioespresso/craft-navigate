...
use studioespresso\navigate\Navigate;
use studioespresso\navigate\assetbundles\navigatefieldfield\NavigateFieldFieldAsset;
 ...
 * @since     0.0.1
 */
class NavigateField extends Field
{
    // Public Properties
    // =========================================================================
    ...
    {
        return Craft::t('navigate', 'NavigateField');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'navigate/_components/fields/NavigateField_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(NavigateFieldFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').NavigateNavigateField(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'navigate/_components/fields/NavigateField_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
